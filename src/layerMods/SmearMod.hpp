...
private:
  ...
  IntentParamController<float> mixNewController { mixNewParameter };
...
//  ofParameter<glm::vec2> translateByParameter { "Translation", glm::vec2 { 0.0, 0.001 }, glm::vec2 { -0.01, -0.01 }, glm::vec2 { 0.01, 0.01 } };
  ...
  IntentParamController<float> field1MultiplierController { field1MultiplierParameter };
//  ofParameter<glm::vec2> field1BiasParameter { "Field1Bias", glm::vec2 { -0.5, -0.5 }, glm::vec2 { -1.0, -1.0 }, glm::vec2 { 1.0, 1.0 } };
  ...
  IntentParamController<float> field2MultiplierController { field2MultiplierParameter };
//  ofParameter<glm::vec2> field2BiasParameter { "Field2Bias", glm::vec2 { -0.5, -0.5 }, glm::vec2 { -1.0, -1.0 }, glm::vec2 { 1.0, 1.0 } };
  ...
  IntentParamController<float> jumpAmountController { jumpAmountParameter }; // only for strategy 2
  ofParameter<float> borderWidthParameter { "BorderWidth7", 0.05, 0.0, 0.49 };
  IntentParamController<float> borderWidthController { borderWidthParameter }; // only for strategy 7
  ...
  IntentParamController<float> ghostBlendController { ghostBlendParameter }; // only for strategy 8
