...
public:
  RandomFloatSourceMod(std::shared_ptr<Synth> synthPtr, const std::string& name, ModConfig config, std::pair<float, float> minRange = {0.0, 1.0}, std::pair<float, float> maxRange = {0.0, 1.0}, unsigned long randomSeed = 0);
