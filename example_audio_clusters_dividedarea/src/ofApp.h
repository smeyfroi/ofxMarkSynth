...
private:
  ...
  ofxMarkSynth::FboPtr fboPtrBackground = std::make_shared<PingPongFbo>();
  ofxMarkSynth::FboPtr fboPtrMinorLines = std::make_shared<PingPongFbo>();
  ofxMarkSynth::FboPtr fboPtrMajorLines = std::make_shared<PingPongFbo>();
